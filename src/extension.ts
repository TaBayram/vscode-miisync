...
function BasicFetch(document: vscode.TextDocument) {
	...
	const url = `http://${userConfig.host}:${userConfig.port}/XMII/Catalog?Mode=SaveBinary&Class=Content&ObjectName=${null}&__=${new Date().getTime()}`;
